...
export function LearningModule({lessonId, title, sections, sectionHrefs, imgSrc, link}) {
    ...
    return (
        <>
            <Link href={link} className='mt-1 pb-10 mt-4 rounded-lg bg-[#212121] hover:bg-[#2c2c2c]'>
                ...
                <h1 className='text-white text-2xl mx-auto ml-10 mt-7 flex'>{title}<span className='ml-auto px-10 font-semibold'>{lessonProgress ? lessonProgress.totalProgress : 0}%</span></h1>
                    ...
                    <div className='mt-4'>
                        <h1 className='text-white text-md flex w-full'>{sections[0]}
                            <span className='ml-auto text-blue-500 hover:text-blue-600'>
                                View Content →
                            </span>
                        </h1>
                        <h1 className='text-white text-md flex'>{sections[1]}
                            <span className='ml-auto text-blue-500 hover:text-blue-600'>
                                View Content →
                            </span>
                        </h1>
                        <h1 className='text-white text-md flex'>{sections[2]}
                            <span className='ml-auto text-blue-500 hover:text-blue-600'>
                                Start Task →
                            </span>
                        </h1>
                        <h1 className='text-white text-md flex'>{sections[3]}
                            <span className='ml-auto text-blue-500 hover:text-blue-600'>
                                Start Task →
                            </span>
                        </h1>
