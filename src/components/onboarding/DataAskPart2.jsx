          ...
          >
            <div className="my-auto mx-auto px-4 ">
              <h1 className="text-xl text-white ">
                {' '}
                Just a few more questions. We're almost done.{' '}
              </h1>
              <div className=" mt-4">
                <div className="isolate -space-y-px rounded-md shadow-sm">
                  <div
                    style={{ borderColor: '#212121' }}
                    className="relative mb-4 rounded-md  border  px-3 py-2 focus-within:z-10 focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600"
                  >
                    <label
                      htmlFor="name"
                  ...
                  <div
                    style={{ borderColor: '#212121' }}
                    className="relative hidden rounded-md  border px-3 py-2 focus-within:z-10 focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600"
                  >
                    <label
                      htmlFor="job-title"
                      className="block text-xs font-medium text-white"
                  ...
                  <div className="mx-auto inline-flex text-center">
                    <input
                      id="legal"
                      style={{ backgroundColor: '#212121' }}
                      type="checkbox"
