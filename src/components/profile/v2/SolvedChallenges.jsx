            ...
            {solvedChallenges.map(challenge => (
              ...
              >
                ...
                <div className='ml-auto '>
                  ...
                  <span className='text-sm text-white'>{challenge.upvotes} <i className='fas fa-arrow-up text-green-500' /></span>
                  <span className='ml-2 text-sm text-white'>{challenge.downvotes} <i className='fas fa-arrow-down text-red-500' /></span>
                </div>
