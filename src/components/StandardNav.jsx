...
export function StandardNav() {
  ...
  return (
    <>
      ...
      {
        isAdmin && (
          <div id="dev-mode" className='bg-neutral-800 py-1 text-sm text-center text-white ' >
            <h1>CTFGuide is running in development mode. This message will auto hide in 3 seconds</h1>
          </div>
        )
      }
