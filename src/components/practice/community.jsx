  ...
  useEffect(() => {
    const filteredChallenges = challenges
      .filter((challenge) => {
        ...
        if (
          category !== 'all' &&
          challenge.category[0].toLowerCase() !== category.toLowerCase()
        ) {
          return false;
        }
        return true;
      ...
      <div className="mt-10 flex max-w-6xl">
        <div className="w-full max-w-xs flex-row-reverse">
          ...
          <select
            ...
            id="difficulty"
            className="mt-1 block w-full rounded  border-none py-2 pl-3 pr-10 pr-40 text-base leading-6 text-white focus:outline-none sm:text-sm sm:leading-5"
            onChange={(e) => {
        ...
        <div className="ml-4 w-full">
          ...
          <input
            ...
            className="mt-1 block w-full rounded py-2 pl-3 pr-10 pr-40 text-base leading-6 text-gray-200 focus:outline-none sm:text-sm sm:leading-5"
          ></input>
        </div>
      </div>
