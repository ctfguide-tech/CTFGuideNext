      ...
      <Dialog as="div" className="relative z-50" onClose={setOpen}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-neutral-900 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl sm:p-6">
                <div>
                          ...
                          <div>
                            ...
                            <p>
                              <span className={`inline-flex items-center rounded-md px-2 py-1 text-sm font-medium ${
                                metadata.severity.toLowerCase() === 'critical' ? 'bg-red-500/15 text-red-700 dark:text-red-400' :
                                metadata.severity.toLowerCase() === 'high' ? 'bg-orange-500/15 text-orange-700 dark:text-orange-400' :
                                metadata.severity.toLowerCase() === 'medium' ? 'bg-yellow-500/15 text-yellow-700 dark:text-yellow-400' :
                ...
                <div className="mt-5 sm:mt-6">
                  <button
                    type="button"
                    className="inline-flex w-full justify-center rounded-md bg-neutral-800 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-neutral-700"
