...
const pages = [{ name: 'Groups', href: '../create', current: false }, {
    name: 'Course Name', href: './', current: false
}, { name: 'New Assignment', href: '#', current: false },
{
    name: 'Fork Challenge', href: '#', current: true
}
];
    ...
    return (<>
        ...
        <main style={styles}>
            ...
            <div className="mx-auto mt-10  max-w-7xl ">
                {challengeSelected ? <Editor data={challengeSlug} /> : <ChallengeSelectView updateChallenge={updateSelectionState}/>}
            </div>
