        ...
        >
            <div className="relative h-full">
                <div className="flex">
                    <span
                        className={
                            'cursor-pointer mr-2 mt-1 rounded-md text-white mb-1 px-2 text-sm font-semibold ' +
                ...
                <p className=" hidden text-[12px] truncate rounded-md  tracking-wide text-white">
                    By: {data.creator}
