  ...
  useEffect(() => {
    ...
    return (
      <div className="bg-black/50 py-12 sm:py-32 -mb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
            <div className="flex p-px lg:col-span-4">
              <div className="overflow-hidden rounded-lg bg-neutral-800/60  ring-white/15 max-lg:rounded-t-[2rem] lg:rounded-tl-[2rem]">
                ...
                />
                <div className="p-10">
                  <h3 className="text-md font-semibold text-neutral-400">Practice Problems</h3>
                  <p className="mt-2 text-xl font-medium tracking-tight text-white">Challenges to test your skills</p>
                  <p className="mt-2 max-w-lg text-md text-neutral-400">
            ...
            <div className="flex p-px lg:col-span-2"> 
              <div className="overflow-hidden rounded-lg bg-neutral-800/60  ring-white/15 lg:rounded-tr-[2rem]">
                ...
                />
                <div className="p-10">
                  <h3 className="text-lg font-semibold text-neutral-400">Chat</h3>
                  <p className="mt-2 text-xl font-medium tracking-tight text-white">Connect with other users</p>
                  <p className="mt-2 max-w-lg text-lg text-neutral-400">
            ...
            <div className="flex p-px lg:col-span-2">
              <div className="overflow-hidden rounded-lg bg-neutral-800/60  ring-white/15 max-lg:rounded-tl-[2rem] lg:rounded-tl-[2rem]">
                <video
                  alt=""
                  src="../lbdemo.mp4"
                ...
                />
                <div className="p-10">
                  <h3 className="text-lg font-semibold text-neutral-400">Leaderboard</h3>
                  <p className="mt-2 text-xl font-medium tracking-tight text-white">Compete with other users</p>
                  <p className="mt-2 max-w-lg text-lg text-neutral-400">
            ...
            <div className="flex p-px lg:col-span-4">
              ...
              <div className="overflow-hidden rounded-lg bg-neutral-800/60  ring-white/15 lg:rounded-bl-[2rem]">
                <video
                  alt=""
                  src="./termdemo.mp4"
                  className=" object-cover"
                ...
                />
                <div className="p-10">
                  <h3 className="text-lg font-semibold text-neutral-400">Web Containers</h3>
                  <p className="mt-2 text-xl font-medium tracking-tight text-white">Browser based virtual machines for solving problems</p>
                  <p className="mt-2 max-w-lg text-lg text-neutral-400">
        ...
        <div
        ref={sectionRef}
        className="bg-black/50 relative mx-auto mt-20 py-10   text-center overflow-hidden"
