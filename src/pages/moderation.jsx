          ...
          <div className='max-w-6xl mx-auto'>
            <div className='flex mt-10'>
              ...
              <div className='ml-auto '>
                <i className='text-4xl fa fa-shield-alt text-white ' />
            ...
            <div className='grid grid-cols-2 gap-x-5 border border-neutral-700 px-4 py-4'>
              ...
              <div>
                ...
                <input type='text' placeholder='Enter USERNAME' className='mb-2 text-white bg-neutral-800 border-none w-full' id='usernameInput' />
                <textarea placeholder='Reason' className='mb-2 text-white bg-neutral-800 border-none w-full' id='reasonInput' />
              ...
              <div>
                ...
                <input type='text' placeholder='Enter CHALLENGE ID' className='mb-2 text-white bg-neutral-800 border-none w-full' />
                <textarea placeholder='Reason' className='mb-2 text-white bg-neutral-800 border-none w-full' />
