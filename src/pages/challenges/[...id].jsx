      ...
      <div className='flex flex-col min-w-[64rem] text-white overflow-x-auto overflow-y-hidden min-h-0 h-screen'>
        ...
        <main className='flex flex-grow p-2 gap-2 overflow-y-hidden'>
          <div className='flex flex-col flex-1 bg-neutral-800 overflow-y-hidden rounded-md'>
            ...
            <div className='flex w-full h-full grow basis-0' />
                ...
                {fetchingTerminal
                  ? (
                    <div className='flex mx-auto text-center justify-center items-center h-full'>
                      <div>
                        <h1 className='text-white text-4xl'><i className='fas fa-spinner fa-spin' /></h1>
...
function TabLink ({ tabName, selected, url }) {
  ...
  return (
    <Link href={url} className={`flex justify-center items-center ${selectedStyle} hover:text-white transition-all duration-400 px-2 hover:bg-neutral-600 rounded-sm h-full`}>
      <i className={`${icon} w-6 mr-1 inline-flex`} />
...
function HintsPage ({ cache }) {
  ...
  return (
    <>
      ...
      <div className='shrink-0 bg-neutral-800 h-10 w-full' />
    </>
  )
}
  ...
  return (
    <>
      <div className='grow bg-neutral-800 text-gray-50 p-3 overflow-y-auto'>
        <h1 className='flex align-middle text-4xl font-semibold py-2 line-clamp-1'>
          ...
          <div className='ml-auto rounded-sm text-right text-2xl flex items-center'>
            <div onClick={upvote} className='cursor-pointer px-2 hover:bg-neutral-700 rounded-sm'>
              <i className='mr-2 fas fa-arrow-up text-green-500 cursor-pointer' />
            ...
            <div onClick={downvote} className='cursor-pointer px-2 hover:bg-neutral-700 rounded-sm'>
              <i className='mr-2 fas fa-arrow-down text-red-500 cursor-pointer' />
            ...
            {username && username === comment.username && (
              <button onClick={() => openDeleteModal(comment.id)} className='ml-2 text-sm text-red-500 opacity-0 group-hover:opacity-100 transition-opacity'><i className='fas fa-trash-alt' /></button>
            )}
          </div>
        </h1>
          ...
          {challenge
            ? <>
              ...
              <p className='flex text-neutral-200 opacity-70 items-center text-sm'>
                <i className='fas fa-solid fa-eye mr-2 text-lg' />
                {challenge.views}
        ...
        <ReactMarkdown />
        {challenge ? <MarkdownViewer content={challenge.content} /> : <Skeleton baseColor='#333' highlightColor='#666' count={8} />}
      </div>
      <div className='shrink-0 bg-neutral-800 h-10 w-full' />
    </>
  )
                ...
                <div className='w-full flex'>
                  ...
                  <div className='ml-auto mt-2'>
                    ...
                    <div className=' space-x-2 text-right text-lg'>
                      <i className='fas fa-arrow-up text-green-500 cursor-pointer' /> {writeup.upvotes}
                      <i className='fas fa-arrow-down text-red-500 cursor-pointer' />  {writeup.downvotes}
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className='px-3'>
          <div className=' w-full mx-auto mt-2 flex rounded-sm bg-neutral-900 py-2.5 '>
            <div className='my-auto mx-auto text-center pt-4 pb-4 text-xl text-white'>
              <i className='text-4xl fas fa-exclamation-circle mx-auto text-center text-neutral-700/80' />
      ...
      <div className='flex'>
        ...
        <div className='ml-auto mt-3 text-right'>
          <button className='hover:text-neutral-200 mb-2' onClick={onBack}>
            <i className='fas fa-long-arrow-alt-left' /> View all writeups
          </button>
          <br />
          <button
          ...
          >
            <i className='fas fa-arrow-up' /> {upvotes !== undefined ? upvotes : <Skeleton width={20} />}
          </button>
          <button
            className='px-2 rounded-full bg-red-700 hover:bg-red-600 ml-2'
            onClick={() => downvoteWriteup(writeup.id)}
          >
            <i className='fas fa-arrow-down' /> {downvotes !== undefined ? downvotes : <Skeleton width={20} />}
          </button>
        </div>
      </div>
      <br />
        ...
        <div className='px-3'>
          <div className='flex justify-center items-center py-2 px-2 bg-neutral-900 rounded-lg my-2'>
            <div className='text-sm text-white'>
              ...
              <p className='text-center'> <img className='w-1/6 mx-auto' src='../../lbmissing.svg' /></p>
          ...
          <div className='flex items-center'>
            <div className='mr-2 text-md text-center text-neutral-400 bg-neutral-700/10 px-1 rounded-md'>
              <button className='hover:text-neutral-600' onClick={() => handleUpvote(comment.id)}>
                <i className='fas fa-arrow-up' /> <span>{comment.upvotes}</span>
              </button>
              <br />
              <button className='hover:text-neutral-600' onClick={() => handleDownvote(comment.id)}>
                <i className='fas fa-arrow-down' /> <span>{comment.downvotes}</span>
              </button>
            </div>
            <img
    ...
    <>
      <div className='grow bg-neutral-800 text-gray-50 p-3 overflow-y-auto'>
        <div className='flex items-center'>
          ...
          <span className='bg-neutral-600 px-1 text-sm ml-2'><i className='fas fa-flask' /> Experimental Feature</span>
        </div>
            ...
            <div className='w-full'>
              ...
              {hasReply &&
                <div className='flex w-full text-left px-2 bg-neutral-500/10 border-none py-1'>
                  ...
                  <button className='ml-auto text-right' onClick={cancelReply}><i className='fas fa-times' /></button>
                </div>}
            </div>
