...
export default function Challenge() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const endPoint =
          process.env.NEXT_PUBLIC_API_URL + '/challenges/' + slug;
      ...
      <Transition.Root show={open} as={Fragment}>
        ...
        >
          <div className="flex min-h-screen items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
              <div className="relative inline-block transform overflow-hidden rounded-lg border border-gray-700 bg-gray-900 px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6 sm:align-middle">
                <div>
                ...
                >
                  <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                    <div className="flex h-full flex-col overflow-y-scroll bg-[#161616] py-6 shadow-xl">
                      ...
                      <div className="relative mt-6 flex-1 px-4 font-medium text-yellow-400 sm:px-6">
                        {hints ? (
