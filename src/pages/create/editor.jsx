...
export default function Create () {
  ...
  const handleLoad = (event) => {
    const cid = router.query.cid // Challenge ID
  ...
  return (
    <>
      ...
      {isLoading &&
        <main className='flex items-center justify-center min-h-screen text-center'>
          <div className='center text-center mx-auto'>
            <h1><i className='fas fa-spinner text-white fa-spin text-4xl mb-5' /></h1>
      ...
      {editorFailure &&
        <main className='flex items-center justify-center min-h-screen text-center'>
          <div className='center text-center mx-auto'>
            <h1><i className='fas fa-exclamation-circle text-white  text-4xl mb-5' /></h1>
        ...
        <main className=''>
          ...
          <div className='text-white text-xl px-6 py-4 w-full bg-neutral-800 flex'>
            ...
            <div className='ml-auto text-sm '>
              <button className='bg-red-600 px-4 py-1 mr-3 rounded-lg'><i className='fas fa-trash fa-fw' /> Delete</button>

              <button onClick={handleSave} className='bg-indigo-600 px-4 py-1 mr-3 rounded-lg'><i className='fas fa-save fa-fw' /> Save</button>

              {isPublished &&
                <button onClick={() => setPublishView(true)} className='bg-green-600 px-4 py-1 mr-3 rounded-lg'><i className='fas fa-rocket fa-fw' /> Publish</button>}
            </div>
          </div>
  ...
  isSaving &&
    <div className='bg-blue-500 center fixed bottom-6 right-6 rounded-md bg-neutral-800/50 text-sm text-white p-2'>
      <i className='fas fa-spinner text-white fa-spin' />  Saving your work...
    </div>
}
                  ...
                  >
                    <div>
                      <div>
                        ...
                        <i className='fas fa-globe text-3xl text-white mt-10' />

                        <h1 className='text-white text-xl font-semibold mt-2'>Publish your writeup</h1>
                      </div>

                      <p className='text-white'>Ready to publish your hard work? <br /><br />Before publishing make sure you're following these rules:</p>
