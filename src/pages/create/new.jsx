...
export default function Createchall() {
    ...
    function uploadChallenge() {
        ...
        console.log("Replacing line breaks: "+tempContent)
    ...
    return (
        <>
            ...
            <main>
              ...
              <textarea onChange={()=>{console.log(document.getElementById('content').value.replace("\n","test"))}}
                  id="content"
              ...
              ></textarea>
                ...
                No hint set
                    ...
                    <button
                        className="mr-2 mt-6 hidden rounded-lg border-blue-600 bg-blue-700 px-4 py-2 text-2xl text-white hover:bg-blue-800">
                ...
                >
                    <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
                        <div
                            className="pointer-events-auto w-full  max-w-sm overflow-hidden rounded-lg border border-gray-700 shadow-lg ring-1 ring-black ring-opacity-5">
                            <div className="p-4">
