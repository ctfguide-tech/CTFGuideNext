...
import MessagesMenu from '@/components/create/Messages'
const pages = [
    { name: 'Creator Dashboard', href: './', current: false },
    { name: 'Edit Challenge', href: '#', current: true },
  ]
...
<div style={{ backgroundImage: "url('http://jasonlong.github.io/geo_pattern/examples/tessellation.png')" }} className="flex mx-auto text-center h-24 my-auto">
    <h1 className='text-4xl text-white mx-auto my-auto font-semibold'>Edit Challenge</h1>
</div>
