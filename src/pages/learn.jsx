            ...
            <main>
                ...
                <div className='max-w-6xl mx-auto mt-10'>
                    ...
                    <div className="grid grid-cols-2 mt-4 gap-x-6 gap-y-6">
                        ...
                        <Link href="feedback.ctfguide.com" className='mt-1 pb-10 mt-4 rounded-lg bg-[#212121] hover:bg-[#2c2c2c]'>
                            <h1 className='text-white text-2xl mx-auto ml-10 mt-7 flex'>More Coming Soon</h1>
