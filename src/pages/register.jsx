                ...
                <div>
                  <div className="mt-2 grid grid-cols-1 gap-3 ">
                    <div>
                      <a
                        href="#"
                        className="inline-flex w-full justify-center rounded-md bg-neutral-800  bg-white py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-neutral-700"
                        onClick={loginGoogle}
                      >
