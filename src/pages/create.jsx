 ...
 <div className=" lg:min-w-0 lg:flex-1">
        <div className="border-b border-t border-neutral-700 pl-4 pr-6 pt-4 pb-4 sm:pl-6 lg:pl-8 xl:border-t-0 xl:pl-6 xl:pt-6">
          <div className="flex items-center">
            <h1 className="flex-1 text-lg font-medium text-white">Your Challenges</h1>
            <div className="relative">
              <button type="button" className="inline-flex w-full justify-center gap-x-1.5 rounded-md  px-3 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-neutral-800" id="sort-menu-button" aria-expanded="false" aria-haspopup="true">
                <svg className="-ml-0.5 h-5 w-5 text-white" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              ...
              <div className="hidden absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md  shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="sort-menu-button" tabindex="-1">
        ...
        <ul role="list" className="divide-y divide-gray-200 border-b border-neutral-700">
            ...
            <div className="flex items-center justify-between space-x-4">
              ...
              <div className="hidden flex-shrink-0 flex-col items-end space-y-3 sm:flex">
                <p className="flex items-center space-x-4">
                  <a href="#" className="relative text-sm font-medium text-white hover:text-white">View Challenge</a>
                  <button type="button" className="relative rounded-full  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                    <span className="sr-only">Add to favorites</span>
                        <svg className="text-yellow-300 hover:text-yellow-400 h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    <div className=" pr-4 sm:pr-6 lg:flex-shrink-0 lg:border-l lg:border-neutral-700 lg:pr-8 xl:pr-0 hidden">
