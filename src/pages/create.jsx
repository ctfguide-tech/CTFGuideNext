...
export default function Create() {
  ...
  const fetchChallenges = async (selection) => {
    ...
    switch (selection) {
      case 'unverified':
        setTitle("Unverified");
        setInfoText("You cannot edit unverified challenges. Please wait for admins to approve these!");
      ...
      case 'pending':
        ...
        setInfoText("These challenges are awaiting changes before moving forward!");
      ...
      case 'published':
        setTitle("Published");
        setInfoText("These challenges are live on CTFGuide. Share them with your friends!");
      ...
      <PopupState variant="popover" popupId="demo-popup-popover">
        {(popupState) => (
          <div>
            ...
            >
              <Typography className="text-white text-md bg-[#323232] border border-[#363636]" sx={{ p: 1 }}>
                {infoText}
              </Typography>
            </Popover>
          </div>
