  ...
  return (
    <>
      ...
      <main>
        ...
        <div className='  top-0 right-0 h-full w-1/2 ' aria-hidden='true' />
            ...
            <div className='min-w-0 flex-1 xl:flex'>
              ...
              <div className=' lg:min-w-0 lg:flex-1 mt-6 rounded-lg '>
                ...
                <div id='saved' className='hidden mb-10 text-white text-center text-xl border  px-2 py-1 rounded-lg bg-green-900 border-green-700 '>
                  <h1><i class='fas fa-check mr-2 ' />  Your challenge has been created and submitted for approval.</h1>
                </div>
                ...
                <div className='  pb-4 xl:border-t-0 '>
                  <div className='flex items-center'>
                    ...
                    <HeadlessPopover className='relative inline-block text-left'>
                      ...
                      >
                        <i className='fas fa-filter -ml-0.5 mt-1.5 h-5 w-5 text-white' />
                        {title}
                        <svg
                                ...
                                <tr key={challenge.id} className='even:bg-neutral-900'>
                                  ...
                                  <td className='relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-3'>
                                    <a href={`/create/edit?cid=${challenge.id}`} className='text-blue-600 hover:text-blue-500'>
                                      <i className='fas fa-pencil-alt mr-1' /> Edit<span className='sr-only'>, {challenge.title}</span>
                                    </a>
                                    ...
                                    >
                                      <i className='fas fa-comments mr-1' /> View Feedback
                                    </button>
                    ...
                    <div>
                      <div className='mx-auto mt-2 flex rounded-sm bg-neutral-800/40 w-full py-2.5 '>
                        <div className='my-auto mx-auto text-center pt-4 pb-4 text-xl text-white'>
                          <i className='text-4xl fas fa-folder-open mx-auto text-center text-neutral-700/80' />
                          ...
                          notifications.slice(0, 3).map((notification) => (
                            <li key={notification.id} className='py-4'>
                              <div className='flex space-x-3'>
                                <i className={`fas ${notification.status === 'approved' ? 'fa-check-circle text-green-500' : 'fa-exclamation-circle text-yellow-500'} mt-4`} />
      ...
      >
        ...
        >
          <h1 id='modal-title' className='text-2xl font-medium text-white'>
            <i className='fas fa-comments mr-1' /> Challenge Feedback
          </h1>
          <p id='modal-description' className='mt-4'>
            <b>Reason for change request:</b><br />
            ...
            <br />
            If you disagree with the changes, please join our <a href='https://discord.gg/bH6gu3HCFF' className='text-blue-500 hover:text-blue-600'><i className='fab fa-discord ' /> Discord</a> and voice your opinion.
            <br />
            <br />
            Thank you!
            <br />
