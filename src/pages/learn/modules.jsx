        ...
        <>
            ...
            <div className='grid grid-cols-6 text-white max-h-screen h-screen max-w-screen '>
                ...
                <div className='col-span-1 bg-neutral-800 max-h-screen max-w-screen px-4 pt-4'>
                    <button onClick={() => setSidebarOpen(!sidebarOpen)} className='absolute top-40 bg-neutral-800 opacity-50 hover:opacity-100 px-2 rounded-r-full py-2 left-80.5 z-10'><i className="fas fa-chevron-left text-xl text-white mr-1"></i></button>
                ...
                {/* Content */}
                <div className={`${sidebarOpen ? 'col-span-5 px-4' : 'col-span-6 px-10'} bg-neutral-900 max-h-screen max-w-screen  pt-4`}>
                    {/* Up Next */}

                {!sidebarOpen && (
                    <button 
                        onClick={() => setSidebarOpen(!sidebarOpen)} 
                        className="absolute top-40 bg-neutral-800 opacity-50 hover:opacity-100 px-2 rounded-r-full py-2 left-0 z-10"
                    >
