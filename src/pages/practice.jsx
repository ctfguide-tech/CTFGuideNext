        ...
        <>
            ...
            <main>
                ...
                <div className="flex flex-col sm:flex-row">
                    <div
                        className="w-full md:w-1/5 flex md:h-screen max-w-7xl md:mx-auto md:justify-center px-8 md:px-16">
                        <PracticeNav/>
                    </div>
                    ...
                    <div className='w-full md:w-4/5 px-8 xl:px-16 border-l border-neutral-800'>
                        <div className='mx-auto'>
                            ...
                            {name ? "" : <a href="/login"><h1
                                className="px-4 py-1 bg-blue-600 hover:bg-blue-500 text-md text-gray-100 tracking-tight mt-10 rounded-md">Log
                                in to view progress!</h1></a>}
                            <div className='bg-neutral-800 px-3 border border-neutral-900 rounded-md mt-4'>
                                ...
                                <div className="px-3">
                                    <h1 className="text-2xl text-gray-100 tracking-tight mt-3 truncate my-auto flex"> Progress
                                        Summary</h1>
                                </div>
                                <div
                                    className='mx-auto text-center grid lg:grid-cols-6 md:grid-cols-2 sm:grid-cols-1 mb-4 mt-2 gap-4 rounded-lg px-3'>
                                    <div
                                        className='hidden px-4 py-2 mx-auto my-auto w-full stext-center text-white rounded-lg'>
                                        <h1 className='text-xl'>Your Performance</h1>
                                    </div>

                                    <div
                                        className='col-span-2 mt-2 bg-[#191919] border border-[#222222] px-4 py-2 mx-auto w-full stext-center text-white rounded-lg'>
                                    ...
                                    <div
                                        className='col-span-2 mt-2 bg-[#191919] border border-[#222222] px-4 py-2 mx-auto w-full text-center text-white rounded-lg '>
                                    ...
                                    <div
                                        className='col-span-1 mt-2 bg-[#191919] border border-[#222222] px-4 py-2 mx-auto w-full text-center text-white rounded-lg '>
                                    ...
                                    <div
                                        className='mt-2 bg-[#191919] border border-[#222222] px-4 py-2 mx-auto w-full stext-center text-white rounded-lg'>
                                ...
                                <div className="px-3 mb-5">
                                    <h1 className="text-2xl text-gray-100 tracking-tight mt-6 truncate my-auto flex"> Your
                                        Insights <p
                                            className='ml-2 my-auto bg-blue-500 rounded-lg text-sm text-white px-2.5 tracking-[.016em]'>EXPERIMENTAL</p>
                                    </h1>
                                    <div>
                                        <p className='mt-3 mb-3 text-white text-xl text-neutral-300 px-2 py-1 border-neutral-700  border-2 rounded-md'
                                           id="insight"><i class="fas fa-spinner fa-spin mr-2"></i>
                                            This Feature is Coming Soon</p>
                                    </div>
                                </div>
                            </div>

                            <h1 className="text-2xl text-gray-100 tracking-tight mt-10 hover:underline">Getting Started
                                🚀</h1>
                            ...
                            <h1 className="text-2xl text-white tracking-tight mt-10 "
                                style={{color: "#595959"}}> SUGGESTED LESSONS</h1>
                            <div className="w-full overflow-x-scroll pb-4">
                                <div className="flex gap-x-5 mt-3" style={{width: "fit-content"}}>

                                    <LearningModule lessonId={1} title={"Linux Basics"}
                                                    sections={["What is Linux?", "Command Basics", "Mastery Task", "Logging into a Server"]}
                                                    imgSrc={"https://camo.githubusercontent.com/81045db2ee0ac7dc57a361737aec02c91af299e8122a4b92748b2acb0b0a89d0/687474703a2f2f6a61736f6e6c6f6e672e6769746875622e696f2f67656f5f7061747465726e2f6578616d706c65732f6469616d6f6e64732e706e67"}
                                                    link={"../learn/ch1/preview"}
                                                    sectionHrefs={["../learn/ch1/preview", "../learn/ch1/video1", "../learn/ch1/activity1", "../learn/ch1/dynamic1"]}/>
                                    <LearningModule lessonId={2} title={"Forensics"}
                                                    sections={["What is Forensics?", "Cyberchef 101", "Mastery Task", "I spy with my little eyes..."]}
                                                    imgSrc={"https://camo.githubusercontent.com/f38cb60cf74f6e673504cbde590a1481018dd3bcb83d4307b3f20bb2a4a992f7/687474703a2f2f6a61736f6e6c6f6e672e6769746875622e696f2f67656f5f7061747465726e2f6578616d706c65732f636f6e63656e747269635f636972636c65732e706e67"}
                                                    link={"../learn/ch2/preview"}
                                                    sectionHrefs={["../learn/ch1/preview", "../learn/ch1/video1", "../learn/ch1/activity1", "../learn/ch1/dynamic1"]}/>
                                    <LearningModule lessonId={3} title={"Cryptography"}
                                                    sections={["What is Cryptography?", "PKI Introduction", "Knees deep into TLS", "Password Dump"]}
                                                    imgSrc={"https://camo.githubusercontent.com/2885763d225b252ff5409416061b0fd287b206fed23a6f96fb7bd5e315782579/687474703a2f2f6a61736f6e6c6f6e672e6769746875622e696f2f67656f5f7061747465726e2f6578616d706c65732f63686576726f6e732e706e67"}
