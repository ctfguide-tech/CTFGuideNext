                  ...
                  <div className="flex px-0 py-0">
                    ...
                    <div>
                      ...
                      <h1 className="text-sm italic text-white">
                        As of March 2023, we are still migrating the data from
                        our old site! Some challenges won't show below.
                      </h1>
                    </div>
                  </div>
                </div>
                <div className="ml-6 mt-6 flex w-1/2 rounded-lg bg-[#212121] px-4 py-2 hover:bg-[#2c2c2c]">
                  <div className="flex px-0 py-0">
                    <div>
                  ...
                  <div className="my-auto ml-auto px-2">
                    ...
                    >
                      Check it out
                      <ArrowRightIcon className="ml-1 mt-1 h-6" />
                    </a>
                  </div>
                </div>
              </div>
