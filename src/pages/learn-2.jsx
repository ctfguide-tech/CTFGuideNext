            ...
            <main>
                <div className='max-w-6xl mx-auto'>
                    ...
                    <div className="grid grid-cols-2 mt-4 gap-4">
                        <a href="../learn/ch1/preview" className='mt-1 py-6 mt-4 rounded-lg ' style={{backgroundColor:"#212121"}}>
                            <h1 className='text-white text-2xl mx-auto ml-10'>Linux Basics</h1>
                        ...
                        <div className='mt-1 py-6 mt-4 rounded-lg' style={{backgroundColor:"#212121"}}>
                            <h1 className='text-white text-2xl mx-auto ml-10'>Cryptography</h1>
                            <div className='px-10 mt-4 text-white'>
                            <ProgressBar percentageValue={45} color="blue" tooltip={true} marginTop="mt-2" />
                            <p1 className="mt-4">43%</p1>
                            </div>
                        ...
                        <div className='mt-1 py-6 mt-4 rounded-lg' style={{backgroundColor:"#212121"}}>
                            <h1 className='text-white text-2xl mx-auto ml-10'>Forensics</h1>
                            <div className='px-10 mt-4 text-white'>
                            <ProgressBar percentageValue={45} color="blue" tooltip={true} marginTop="mt-2" />
                            <p1 className="mt-4">43%</p1>
                            </div>
