          ...
          <Transition.Root show={isPopupOpen} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={() => handlePopupClose()}>
              ...
              <div className="flex items-end justify-center min-h-screen pt-4 px-4 text-center sm:block sm:p-0">
                ...
                >
                  <div style={{ fontFamily: 'Poppins, sans-serif', backgroundColor: "#161716" }} className="max-w-6xl relative inline-block align-bottom w-5/6 pb-10 pt-10 bg-gray-900 border border-gray-700 rounded-sm px-20 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle ">
                    <div>
                      <div className="mt-3 sm:mt-5">
                        ...
                        <div className="grid grid-cols-2 flex justify-center items-center">
                          ...
                          {/* INPUT BOX */}
                          <div
                            className="h-72 w-80 border border-neutral-800 mx-20 relative rounded-sm p-4 text-center cursor-pointer flex items-center justify-center"
                            onClick={handleClick}
                        ...
                        <div className="grid grid-cols-2 pt-5">
                          <div className="flex items-center justify-end">
                            <button className="border border-neutral-700 mx-3 rounded-sm w-20 text-white py-2 bg-neutral-800 hover:text-neutral-500"
                              onClick={() => handlePopupClose()}>Close
                            </button>
                          </div>
                          <div className="flex items-center justify-start">
                            <button className="border border-neutral-700 mx-3 rounded-sm w-20 text-white py-2 bg-green-900 hover:text-neutral-500"
        ...
        <div className="container  max-w-6xl mx-auto mt-5 h-full justify-center">
          <div className="flex justify-center flex-rows w-full ">
            ...
            <div className="h-full w-full">
              <div className="rounded-sm bg-neutral-800 shadow p-2 h-full mb-4">
                    ...
                    {((openBio && ownUser) &&
                      <div>
                        <textarea
                          ...
                          onChange={openBanner}
                          value={tempBio}
                          className="w-full rounded-sm border-white/10 bg-neutral-900/50 px-6 pt-3 pb-12 text-lg text-white"
                        ></textarea>
                      </div>
                    ) || (
                        <div className="w-full h-full border border-2 border-white/10 rounded-sm bg-neutral-800 px-6 pt-3 pb-20 text-lg text-white">
                          <Markdown>
          ...
          <div>
            <div className=" rounded-sm mt-4 ">
              ...
              <div className="rounded-sm">
                ...
                <div className="bg-neutral-800 rounded-sm grid grid-cols-5 gap-x-2 gap-y-2 py-4 px-4">
                  {badges && badges.length > 0 ? (
                    ...
                    <div
                      className="border col-span-5 border-neutral-700 border-2 bg-neutral-800 align-center mx-auto w-full rounded-sm px-4 py-4 text-center duration-4000 min-h-[190px] min-w-[200px] transition ease-in-out hover:bg-neutral-700/40"
          ...
          <div>
            {/* Join Date */}
            <div className="rounded-sm mt-12 ">
              {/* Badge Content */}
