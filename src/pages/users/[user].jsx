...
export default function Create () {
  ...
  const [totalCompletedChallenges, setTotalCompletedChallenges] = useState(0)
    ...
    return (
      <>
        {!isBioExpanded && <button
          ...
          <i class='pointer-events-auto text-xl mt-2 mr-4 text-white hover:text-gray-400 fas fa-edit' />
        </button>}
      </>
    )
  }
                      ...
                      <h1 className='f mt-8 truncate text-2xl font-bold text-white'>
                        ...
                        {user && user.role === 'ADMIN' && (
                          <span className='bg-red-600 px-1 text-sm ml-4'>
                            <i className='fas fa-code fa-fw' /> developer
                          </span>
                        )}

                        {user && user.role === 'PRO' && (
                          <span className='bg-gradient-to-br from-orange-400 to-yellow-600 px-1 text-sm ml-4'>
                            <i className='fas fa-crown fa-fw' /> pro
                          </span>
                        )}
                        {!ownUser && followedUser && (
                          <span className='ml-2 text-lg'>
                            <i className='text-lg fas fa-user-slash hover:text-gray-400' onClick={handleUnfollowUser} />
                          </span>
                        )}
                        {!ownUser && !followedUser && (
                          <span className='ml-2 text-lg'>
                            <i className='text-lg fas fa-user-plus hover:text-gray-400' onClick={handleFollowUser} />
                          </span>
                        )}
                      </h1>
        ...
        <div className='mt-10 grid grid-cols-1 gap-y-4 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-4 lg:gap-x-4 '>
          <div className='h-40 w-full border-t-4 border-blue-600 bg-neutral-800'>
            ...
            <div className='col-span-2 bg-neutral-800 px-4 pt-4'>
              ...
              <hr className='mt-4 border-neutral-700 px-4' />
            </div>
                        ...
                        <div className='mt-4 w-full border-t-4 border-blue-600 bg-neutral-800 px-4 py-4'>
                          ...
                          <div className='flex justify-center'>
                            {activityData &&
                              <ActivityCalendar
                                data={activityData}
                                showMonthLabels // Ensure month labels are shown
                                theme={{
                                  light: [
                                    '#1f1f1f',
                                    '#c0d7ff',
