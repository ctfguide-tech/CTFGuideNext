...
export default function Users() {
  ...
  const [pfp, setPfp] = useState(
    process.env.NEXT_PUBLIC_FRONTEND_URL + `ConfusedKana.png`
  );
    ...
    const fetchData = async () => {
      try {
        const challengeEndPoint =
          process.env.NEXT_PUBLIC_API_URL + '/users/' + user + '/challenges';
    ...
    const fetchData = async () => {
      try {
        ...
        if (result) {
          ...
          setPfp(
            `https://robohash.org/${localStorage.getItem(
              'username'
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const endPoint =
          process.env.NEXT_PUBLIC_API_URL + '/users/' + user + '/banner';
        const result = await request(endPoint, 'GET', null);
        console.log(result);
        if (result) {
          if (
                    ...
                    <div className="flex">
                      ...
                      {!ownUser &&
                        (!followedUser ? (
                          ...
                          >
                            <i class="fas fa-solid fa-users-slash text-xl text-white hover:text-gray-400"></i>{' '}
        ...
        <div className="container  mx-auto mt-5 h-full max-w-6xl justify-center">
          <div className="flex-rows flex w-full justify-center ">
            ...
            <div className="h-full w-full">
              <div className="mb-4 h-full rounded-sm bg-neutral-800 p-2 shadow">
                ...
                <div>
                  <div className="px-5 pb-5">
                    {(openBio && ownUser && (
                      ...
                      <div className="h-full w-full rounded-sm border border-2 border-white/10 bg-neutral-800 px-6 pb-20 pt-3 text-lg text-white">
                        <Markdown>
                ...
                <div className="my-6">
                  ...
                  <div className="my-8 flex items-center justify-center">
                    {completedChallenges && (
                      <PieChart
                        data={[
                          completedChallenges.completedBeginnerChallenges
                            .length,
          ...
          <div>
            <div className=" mt-4 rounded-sm ">
              ...
              <div className="rounded-sm">
                <h1 className="mb-3 ml-2 text-3xl font-semibold text-gray-300">
                  Badges
                </h1>
                <div className="grid grid-cols-5 gap-x-2 gap-y-2 rounded-sm bg-neutral-800 px-4 py-4">
                  {badges && badges.length > 0 ? (
                    ...
                    <div
                      className="align-center duration-4000 col-span-5 mx-auto min-h-[190px] w-full min-w-[200px] rounded-sm border border-2 border-neutral-700 bg-neutral-800 px-4 py-4 text-center transition ease-in-out hover:bg-neutral-700/40"
          ...
          <div>
            ...
            <div className="rounded-sm">
              <div className="rounded-sm">
                <h1 className="ml-2 mt-4 py-2 text-3xl font-semibold text-gray-300">
                  Created Challenges
                </h1>
                <div className="mt-2 flex grid grid-cols-3 flex-col gap-x-4 gap-y-2 rounded-sm bg-neutral-800 p-4">
                  {(createdChallenges &&
