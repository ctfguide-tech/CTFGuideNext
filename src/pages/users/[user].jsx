    ...
    return (
        <>
                                    ...
                                    <div className="mt-6  flex w-full">
                                        <div>
                                            <h1 className="f mt-8 truncate text-2xl font-bold text-white">
                                                ...
                                                {user && user.role === 'PRO' && (
                                                    <span
                                                        className="bg-gradient-to-br from-orange-400 to-yellow-600 px-1 text-sm ml-4">
            ...
            <main className="mx-auto mt-10 max-w-7xl">
                <div
                    className="mt-10 grid grid-cols-1 gap-y-4 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-4 lg:gap-x-4 ">
                                    ...
                                    <div>
                                        ...
                                        <div className="w-full">
                                            <div className="text-white">
                                                <div
                                                    className="mt-4 w-full border-t-4 border-blue-600 bg-neutral-800 px-4 py-4">
