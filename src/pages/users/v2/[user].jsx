                ...
                {true ? (
                  <div className="gap-4">
                    <main className="flex justify-center p-4">
                      <div className="grid max-w-7xl grid-cols-1 gap-5 sm:grid-cols-1 lg:grid-cols-2">
              ...
              <>
                <div className="bg-neutral-800 px-4 py-4">
                  ...
                  {true ? (
                    <div className="gap-4">
                      <main className="flex justify-center p-4">
                        <div className="grid max-w-7xl grid-cols-1 gap-5 sm:grid-cols-1 lg:grid-cols-3">
                          {sampleData.mutuals.length > 0 ? (
                            sampleData.mutuals.map((mutual, index) => (
                              <FriendCard
                                key={index}
